...
const defaultSettings: ClinicSettings = {
    ...
    smsEnabled: true,
    logo: "",
    smsConfig: { apiKey: "", senderId: "MOBIWAVE" },
    paymentConfig: {
        provider: "None",
        apiKey: "",
        secretKey: "",
    ...
    security: { twoFactorEnabled: false, lastPasswordChange: "2023-09-15" },
    billing: {
        plan: "Pro",
        status: "Active",
        nextBillingDate: "2023-11-01",
        paymentMethod: { type: "Card", last4: "4242", brand: "Visa", expiry: "12/25" },
    },
