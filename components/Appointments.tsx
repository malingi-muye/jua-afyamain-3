...
const Appointments: React.FC<AppointmentsProps> = ({
  ...
  return (
    <div
      className="p-6 md:p-10 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-200"
      onClick={() => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm outline-none focus:ring-2 focus:ring-teal-500 w-48 md:w-64 dark:text-white"
            />
            {searchTerm && (
              <button
          ...
          <button
            ...
            className="p-2.5 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
            title="Export CSV"
          >
          ...
          <button
            ...
            className="bg-slate-900 dark:bg-teal-600 text-white flex items-center gap-2 px-5 py-2.5 rounded-xl hover:bg-slate-800 dark:hover:bg-teal-700 shadow-lg shadow-slate-200 dark:shadow-none font-medium transition-colors"
          >
