              ...
              <div className="absolute bottom-full left-0 w-full mb-2 bg-white text-slate-800 rounded-xl shadow-xl overflow-hidden animate-in slide-in-from-bottom-2">
                ...
                <div className="max-h-48 overflow-y-auto">
                  ...
                  {team.map((member) => (
                    ...
                    >
                      <div
                        className="w-2 h-2 rounded-full mr-3 bg-slate-300"
                        style={{ backgroundColor: currentUser.id === member.id ? "#10b981" : undefined }}
                      ></div>
                ...
                >
                  <div className="w-8 h-8 rounded-full mr-3 bg-indigo-600 text-white flex items-center justify-center font-bold text-xs">
                    SA
                  </div>
                  <div className="text-left">
                ...
                <button
                  ...
                  className="w-full flex items-center p-3 hover:bg-red-50 text-red-600 transition-colors disabled:opacity-50"
                >
