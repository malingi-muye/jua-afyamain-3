                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${
                      selectedVisit.priority === "Emergency"
          ...
          {visibleStages.map((stage) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center p-2 sm:p-3 rounded-2xl transition-all border-2 relative flex-shrink-0 ${
                  isActive
