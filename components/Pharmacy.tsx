    ...
    const renderStats = () => (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
            <div
                ...
                className="bg-purple-600 text-white p-4 md:p-6 rounded-2xl shadow-lg shadow-purple-200 dark:shadow-none flex items-center gap-4 cursor-pointer hover:scale-105 transition-transform group"
            >
            ...
            <div
                ...
                className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex items-center gap-4 cursor-pointer hover:border-blue-200 transition-colors group"
            >
            ...
            <div
                ...
                className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex items-center gap-4 cursor-pointer hover:border-red-200 transition-colors group"
            >
            ...
            <div
                ...
                className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex items-center gap-4 cursor-pointer hover:border-orange-200 transition-colors group"
            >
    ...
    const renderInvoicesTab = () => {
        ...
        return (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden overflow-x-auto">
